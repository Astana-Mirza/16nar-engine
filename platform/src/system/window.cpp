...
Window::Window( math::Vec2i size, const std::string& title, const OpenSettings& settings ):
     window_{ nullptr }
{
...
Window::Window( math::Vec2i size, const std::string& title,
...
{
     check_window_open( window_ );
     const auto* mode = glfwGetVideoMode( monitor.monitor_ );
...
{
     check_window_open( window_ );
     auto *mon = ::glfwGetWindowMonitor( window_ );
     if ( !mon )
     {
