/// @file
/// @brief Utility functions for reading and writing files.
#ifndef _16NAR_PLATFORM_SYSTEM_FILE_H
#define _16NAR_PLATFORM_SYSTEM_FILE_H
...
class NARENGINE_PLATFORM_API File
{
public:
     ...
     std::size_t write( memory::ConstByteView buffer ) noexcept;

     /// @brief Read buffer from the file.
     /// @param[out] buffer buffer to be filled with read bytes.
     /// @return count of read bytes.
     std::size_t read( memory::ByteView buffer ) const noexcept;
...
#endif // #ifndef _16NAR_PLATFORM_SYSTEM_FILE_H
