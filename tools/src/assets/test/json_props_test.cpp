...
TEST_CASE( "Properties reading and writing in JSON format", "[json_props]" )
{
     ...
     _16nar::tools::JsonPropsWriter writer{};
     ...
     std::ofstream ofs{ "data/out/props.json" }; // for diagnostic purposes
     ofs << std::setw( 4 ) << result << std::endl;

     _16nar::tools::JsonPropsReader reader{ result, true };
