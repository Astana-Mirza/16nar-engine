...
#ifndef _16NAR_TOOLS_RESOURCE_PKG_VISITOR_H
#define _16NAR_TOOLS_RESOURCE_PKG_VISITOR_H
...
class ENGINE_API ResourcePkgVisitor : public IAssetVisitor
{
public:
     ...
     void process_resource_package( IAssetReader& reader );

     /// @brief Process single resource tree using the reader and make visits.
     /// @throws std::runtime_error or format-specific exceptions in case of parsing errors.
     /// @param[in] reader asset reader.
     void process_resource( IAssetReader& reader );
};

} // namespace _16nar::tools

#endif // #ifndef _16NAR_TOOLS_RESOURCE_PKG_VISITOR_H
