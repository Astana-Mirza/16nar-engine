...
#ifndef _16NAR_TOOLS_LOGGER_H
#define _16NAR_TOOLS_LOGGER_H
...
#define __NARENGINE_LOG_IMPL( LEVEL, FORMAT, ... ) \
     ::_16nar::Logger::instance().log( \
          ::_16nar::Logger::LogLevel::LEVEL, ( FORMAT ), __VA_ARGS__ )
...
#endif // #ifndef _16NAR_TOOLS_LOGGER_H
