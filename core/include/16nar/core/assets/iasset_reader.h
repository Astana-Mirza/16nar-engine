...
#ifndef _16NAR_CORE_ASSETS_IASSET_READER_H
#define _16NAR_CORE_ASSETS_IASSET_READER_H
...
public:
     ...
     virtual void reset( memory::ConstByteView buffer ) = 0;
...
#endif // #ifndef _16NAR_CORE_ASSETS_IASSET_READER_H
