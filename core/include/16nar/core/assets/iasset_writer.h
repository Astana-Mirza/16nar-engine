...
#ifndef _16NAR_CORE_ASSETS_IASSET_WRITER_H
#define _16NAR_CORE_ASSETS_IASSET_WRITER_H
...
public:
     ...
     virtual memory::ConstByteView finish( std::uint32_t root_id ) = 0;
...
#endif // #ifndef _16NAR_CORE_ASSETS_IASSET_WRITER_H
