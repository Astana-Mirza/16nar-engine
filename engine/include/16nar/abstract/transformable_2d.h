...
public:
     ...
     virtual void set_scale( const Vec2f& factors )                = 0;
     ...
     virtual void set_origin( const Vec2f& origin )                = 0;
