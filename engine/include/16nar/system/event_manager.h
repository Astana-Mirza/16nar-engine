...
public:
     ...
     /// @param[in] key key triggering press and relese.
     /// @param[in] action action referenced to this event.
     void add_pressable_key( Keyboard::Key key, int action );

     /// @brief Sets the manager to listen to joystick button press and release.
     /// @param[in] button number of button of the joystick.
     /// @param[in] action action referenced to this event.
     ...
     /// @param[in] action checked action.
     /// @param[in] joystick number of joystick (starts from 1, 0 is keyboard + mouse, -1 is any device).
