...
public:
     ...
     Camera2D( const Vec2f& center, float width, float height );
     ...
     void reset( const Vec2f& center, float width, float height );
     ...
     TransformMatrix get_inverse_transform_matr() const;

private:
     /// @brief Do calculations of transofrmation matrix and global bounds.
     void params_calculate() const;
